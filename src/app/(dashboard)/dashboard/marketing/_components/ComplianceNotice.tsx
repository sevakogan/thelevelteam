  ...
  return (
    <div className="border border-separator rounded-xl overflow-hidden">
      ...
      <button
        ...
        className="w-full px-4 py-3 border-b border-separator bg-brand-border/10 flex items-center justify-between"
      >
        <div className="flex items-center gap-2">
          <svg className="w-4 h-4 text-amber-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M12 9v3.75m9-.75a9 9 0 11-18 0 9 9 0 0118 0zm-9 3.75h.008v.008H12v-.008z" />
          </svg>
          <span className="text-sm text-foreground font-medium">Legal &amp; Compliance</span>
        ...
        <div className="p-4 space-y-6">
          ...
          <div>
            ...
            {editingSmsConsent ? (
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between pt-1">
                  <button
                    ...
                    className="text-[11px] text-brand-muted hover:text-foreground transition-colors"
                  >
                    Reset to default
                  </button>
                  <button
              ...
              <div className="rounded-lg border border-separator bg-brand-border/5 px-3 py-2">
          ...
          <div>
            ...
            <div className="space-y-2">
              {COMPLIANCE_ITEMS.map((item) => (
                <div
                  key={item.label}
                  className="flex items-start gap-2 rounded-lg border border-separator/50 px-3 py-2"
                >
          ...
          <div className="flex items-center justify-end gap-3 pt-2 border-t border-separator/50">
            {saved && (
            ...
            <button
              type="button"
              onClick={handleSave}
              className="flex items-center gap-1.5 text-xs font-medium text-foreground bg-accent-blue/20 hover:bg-accent-blue/30 border border-accent-blue/30 hover:border-accent-blue/50 px-4 py-1.5 rounded-lg transition-colors"
            >
              <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
