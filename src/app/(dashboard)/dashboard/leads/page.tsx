...
export default function LeadsPage() {
  ...
  return (
    <div>
      ...
      {leads.length === 0 ? (
        <div className="text-center py-16 border border-separator rounded-xl">
        ...
        <div className="overflow-x-auto border border-separator rounded-xl">
          <table className="w-full text-sm">
            <thead>
              <tr className="border-b border-separator bg-brand-border/10">
            ...
            <tbody>
              {leads.map((lead) => (
                <tr
                  ...
                  className="border-b border-separator/50 hover:bg-accent-blue/5 cursor-pointer transition-colors group"
                >
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2.5">
                      ...
                      <div className="min-w-0">
                        <span className="text-foreground font-medium group-hover:text-accent-blue transition-colors block truncate">
                          {lead.name}
                        </span>
                        {lead.company && (
