...
export const projectContent: Record<string, ProjectDetail> = {
  ...
  "wecare-drive": {
    slug: "wecare-drive",
    headline: "Medical Supply Delivery Logistics",
    longDescription:
      "WeCare Drive is a comprehensive logistics platform built for medical supply delivery drivers and their managers. The system handles everything from daily delivery scheduling to expense tracking and performance reporting.\n\nDrivers use the platform to view their daily routes, log deliveries, track expenses, and submit reports. Administrators get a bird's-eye view of all driver activity with real-time statistics, performance metrics, and automated report generation. The platform integrates with Google APIs for document management and uses NextAuth for secure, role-based authentication.",
    features: [
      {
        title: "Calendar-Based Scheduling",
        description: "Visual calendar showing daily deliveries with 4-week pre-fetching for efficient route planning.",
        icon: "calendar",
      },
      {
        title: "Expense Tracking",
        description: "Drivers log mileage, fuel, and other expenses directly in the app with receipt uploads.",
        icon: "dollar",
      },
      {
        title: "Role-Based Access",
        description: "Three-tier system: drivers, case managers, and admins each with tailored dashboards.",
        icon: "users",
      },
      {
        title: "Automated Reports",
        description: "Weekly and monthly performance reports generated as PDFs with charts and statistics.",
        icon: "document",
      },
      {
        title: "Google Integration",
        description: "Connects with Google Sheets and Docs for seamless data export and document management.",
        icon: "link",
      },
      {
        title: "Real-Time Statistics",
        description: "Live dashboard showing today's completions, weekly counts, and monthly performance trends.",
        icon: "analytics",
      },
    ],
    screenshots: [
      ...
      { src: "/screenshots/wecare-drive/settings.png", alt: "Settings and vacation management", caption: "Settings and vacation management" },
      { src: "/screenshots/wecare-drive/mobile.png", alt: "Mobile dashboard view", caption: "Mobile-friendly driver interface" },
    ],
    outcomes: [
      "Multi-role system serving drivers, managers, and admins",
      "Automated PDF report generation with pdf-lib",
      "Google Sheets integration for data exports",
      "Calendar-based scheduling with 4-week lookahead",
    ],
    usesGHL: false,
